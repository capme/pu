...
class Paymentconfirmation_m extends MY_Model {
	...
	{
		$this->db = $this->load->database('mysql', TRUE);
		$this->db->select('*, bank_confirmation.client_id, bank_confirmation.status as status_bank, order_history.status as status_history, bank_confirmation.created_at, bank_confirmation.id, bank_confirmation.updated_at, auth_users.username, order_history.type, order_history.created_at as history_date');
