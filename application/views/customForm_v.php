...
<div class="portlet box blue ">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form action="<?php echo site_url($this->router->class . "/" . $formAction)?>" method="POST" class="form-horizontal form-bordered form-row-stripped" id="<?php echo "form_".$this->va_input->getGroup(); ?>" enctype="multipart/form-data">
			<div class="form-body">
