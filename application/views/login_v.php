...
<head>
<meta charset="utf-8"/>
<title>Leger Management <System></System></title>
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="/login/do_login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username or Email" name="username"/>
			</div>
		</div>
		<div class="form-group">
...
<script>
	...
	<?php  if(@$alert_msg AND @$alert_type == 'success') {?>
	$('.alert').removeClass('alert-danger').addClass('alert-success');
	$('.alert > span').html('<span><?php echo @$alert_msg ?></span>');
	$('.alert').show();
	<?php } else if (@$alert_msg AND @$alert_type == 'error') { ?>
